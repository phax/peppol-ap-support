 ...
 */
public interface PeppolReportStorageFilenameProvider
{
  @Nonnull
  ...
  PeppolReportStorageFilenameProvider DEFAULT = (period, type, creationDT, suffix) -> StringHelper.getLeadingZero (
                                                                                                                   period.getYear (),
                                                                                                                   4) +
                                                                                      '/' +
